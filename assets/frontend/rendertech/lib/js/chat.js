...
var newmsg="yes";
var soundHandle;
var browserTitle = "Render Tech Production";
...
function showOnline() {	
	...
	$.ajax({url:"con_/chatProcessRequest.php", type:"POST", dataType:"xml", data:""+str+"", success:function(result){
				var onlineStatus = $(result).find("root").attr("online");
				
				if(onlineStatus=="yes") {
					$("div#online_users_box").html("<img class='' style='padding-left:65px;' src='lib_/images/loader.gif'>");
				        refreshOnline();
...
function refreshOnline() {	
	var search = $("div#online_search_box input").val();
                ...
                $.ajax({url:"con_/chatShowOnline.php", success:function(result){
                $("div#online_users_box").html(result);
                noOfUsers = $("div#user").toArray();
                $("div#online_title").html("Chat Operator");
                }});
...
function goOffline() {
	...
	$("div#online_title").html("<i class='fa fa-power-off'></i> Anda offline.. ");
	$("div#min").hide();
	$("div#online_users_box").hide();
	$("div#online_search_box").hide();
	$("div#online_box").css("height","36px");
}

function goOnline() {
	setOnlineStatus("yes");
	$("div#online_title").text("Chat Operator");
        $("div#min").show();
...
function setOnlineStatus(onlineStatus) {
		...
		$.ajax({url:"con_/chatProcessRequest.php", type:"POST", data:""+str+""});
}
...
function chatWith(username,enroll) {
	...
	$("div#chatbox_"+enroll+" div.chatbox_title").css("background-color","#10c469");
...
function minimizeAllChats() {
	...
	$("div.chatbox_user").css({"position":"relative","top":"265px","cursor":"pointer"});
...
function minimizeChat(roll) {
	...
	$("div#chatbox_"+roll+" div#minChat").hide();
        ...
        $("div#chatbox_"+roll).css({"position":"relative","top":"265px","cursor":"pointer"});
...
function constructChatbox(enroll,username) {
		...
		$("div#chatbox_"+enroll).append("<div><div class='chatbox_title' onclick='javascript:restructChatbox(&#39;"+enroll+"&#39;,&#39;"+username+"&#39;)'>"+username+"</div><div id='minChat' class='opt' onClick='javascript:minimizeChat(&#39;"+enroll+"&#39;)'> <i class='fa fa-minus'></i> </div><div id='closeChat' class='opt' onClick='javascript:closeChat(&#39;"+enroll+"&#39;)'><i class='fa fa-close'></i></div></div>");
		...
		$("div#chatbox_"+enroll+" div.chatbox_msg").html("<img class='' style='padding-left:85px;' src='lib_/images/loader.gif'>");
...
function restructChatbox(roll,name) {
	...
	$("div#chatbox_"+roll+" div.chatbox_title").css("background-color","#10c469");
...
function sendChat(roll,name) {
	...
	if(msg.length!=0) {
		$.ajax({url:"con_/chatProcessRequest.php", type:"POST", data:""+str+"", dataType:"xml", success:function(result) {
	...
	$.ajax({url:"con_/chatProcessRequest.php", type:"POST", data:""+str+"", dataType:"xml", success:function(result){
			...
			if(c>0) {
				$(result).find("users").each(function(){ 
					...
					if($("div#chatbox_"+roll).css("top")=="265px"){
						setBrowserTitle(name);
						playSound();
						$("div#chatbox_"+roll).show();
						$("div#chatbox_"+roll+" div.chatbox_title").css("background-color","#13E67C");
