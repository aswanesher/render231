...
"use strict"; 
        ...
        $("form:not(.pix_paypal)").live( "submit", function( event ) {
            ...
            if(is_confirm){
                ...
                var pix_over = 'rgba(0,0,0,0.5)';
                var pop_ref = "#" + confirm_pop;
                if($(pop_ref).attr('pix-overlay')){
                    pix_over = $(pop_ref).attr('pix-overlay');
                }
                var pix_class = '';
                if($(pop_ref).attr('pix-class')){
                    pix_class = $(pop_ref).attr('pix-class');
                }
                this.overlay = pix_over;
            ...
            {   
                ...
                $.post('kirimpesan', values, function(response){  
