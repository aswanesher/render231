...
"use strict"; 
        ...
        $(".form_testimonial").live( "submit", function( event ) {
            event.preventDefault();
            var values = {};
            var temp_str = "";
            var theform = this;
            ...
            {   
                ...
                $.post('../testimonialprocess/kirim', values, function(response){  
        ...
        $(".form_registrasi").live( "submit", function( event ) {
            event.preventDefault();
            var values = {};
            var temp_str = "";
            var theform = this;
            ...
            {   
                ...
                var output;
                //Ajax post data to server
                $.post('../registerprocess/kirim', values, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
        ...
        $(".kirim_pesans").live( "submit", function( event ) {
            event.preventDefault();
            var values = {};
            var temp_str = "";
            var theform = this;
            ...
            {   
                ...
                var output;
                //Ajax post data to server
                $.post('../sendemail/kirim', values, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
