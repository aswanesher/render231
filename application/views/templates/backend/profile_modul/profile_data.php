<div class="page-header">
		<h1>
			...
			<?php if($tambah=='true') { ?>
			<a href="<?php echo base_url();?>profile/profile_add" class="btn-sm btn-success pull-right"><i class="ace-icon fa fa-pencil-square-o bigger-230"></i> Tambah data</a>
			<?php } ?>
		</h1>
	</div><!-- /.page-header -->
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form class="form-search" method="post" action="<?php echo base_url()?>profile">
							<div class="row">
...
<td>
									<div class="hidden-sm hidden-xs btn-group">
										<?php if($edit=='true') { ?>
										<a class="btn btn-xs btn-info" href="<?php echo base_url();?>profile/profile_edit/<?php echo $row->ID?>">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</a>
										<?php } ?>

										<?php if($hapus=='true') { ?>
										<a class="btn btn-xs btn-danger" href="<?php echo base_url();?>profile/profile_delete/<?php echo $row->ID?>" onclick="return confirm('Anda yakin akan menghapus user ini?')">
