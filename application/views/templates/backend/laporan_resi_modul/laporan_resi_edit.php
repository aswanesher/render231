...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="<?php echo base_url('laporan_resi/laporan_resi_update'); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="nama" value="<?php echo $nama?>" placeholder="Nama Penerima" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="no_resi" value="<?php echo $no_resi?>" placeholder="No. Resi" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" id="form-field-1-1" name="ukuran" value="<?php echo $ukuran?>" placeholder="Ukuran" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" id="cal" name="ongkir" value="<?php echo $ongkir?>" placeholder="Status" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" id="cal2" name="jml_transfer" value="<?php echo $ditransfer?>" placeholder="Status" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" id="sum1" name="selisih" value="<?php echo $selisih?>" placeholder="Status" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group" id="date-picker">
			...
			<div class="col-sm-2">
				<input type="text" name="post_date" placeholder="Tanggal" value="<?php echo $tanggal?>" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" required />
			</div>	
		</div>
