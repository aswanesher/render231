...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="<?php echo base_url('post/post_update'); ?>" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-sm-9">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<?php foreach ($kategori as $r) { ?>
										<option value="<?php echo $r->post_parent;?>" <?php if($r->post_parent==$post_parent) { echo "selected"; } ?>><?php echo $r->category;?></option>
									<?php } ?>	
									</select>
								</div>
							</div>
