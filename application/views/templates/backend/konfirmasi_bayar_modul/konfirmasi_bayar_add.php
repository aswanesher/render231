...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="<?php echo base_url('konfirmasi_bayar/konfirmasi_bayar_save'); ?>" method="post" enctype="multipart/form-data"><div class="form-group">
