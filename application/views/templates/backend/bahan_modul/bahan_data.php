<div class="page-header">
		<h1>
			...
			<?php if($tambah=='true') { ?>
			<a href="<?php echo base_url();?>bahan/bahan_add" class="btn-sm btn-success pull-right"><i class="ace-icon fa fa-pencil-square-o bigger-230"></i> Tambah data</a>
			<?php } ?>
		</h1>
	</div><!-- /.page-header -->
	<?php
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form class="form-search" method="post" action="<?php echo base_url()?>bahan">
							<div class="row">
...
<td>
									<div class="hidden-sm hidden-xs btn-group">
										...
										<?php if($hapus=='true') { ?>
										<a class="btn btn-xs btn-danger" href="<?php echo base_url();?>bahan/bahan_delete/<?php echo $row->id_bahan?>" onclick="return confirm('Anda yakin akan menghapus user ini?')">
