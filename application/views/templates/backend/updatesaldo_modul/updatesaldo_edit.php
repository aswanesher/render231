...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="http://localhost/kaosnyabagus/updatesaldo/updatesaldo_update" method="post" enctype="multipart/form-data"><div class="form-group">
