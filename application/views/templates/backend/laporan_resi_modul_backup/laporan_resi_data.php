		...
		<h1>
			...
			<?php if($tambah=='true') { ?>
			<a href="<?php echo base_url();?>laporan_resi/laporan_resi_add" class="btn-sm btn-success pull-right"><i class="ace-icon fa fa-pencil-square-o bigger-230"></i> Tambah data</a>
			<?php } ?>
		</h1>
	</div><!-- /.page-header -->
	<?php
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<a href="<?php echo base_url();?>laporan_resi/export" class="btn-sm btn-danger pull-right"><i class="ace-icon fa fa-save bigger-240"></i> Export data</a>
