<div class="page-header">
		<h1>
			...
			<?php if($tambah=='true') { ?>
			<a href="<?php echo base_url();?>detailpesanan/detailpesanan_add" class="btn-sm btn-success pull-right"><i class="ace-icon fa fa-pencil-square-o bigger-230"></i> Tambah data</a>
			<?php } ?>
		</h1>
	</div><!-- /.page-header -->
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form class="form-search" method="post" action="<?php echo base_url()?>detailpesanan">
							<div class="row">
					...
					<table id="simple-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th>#</th><th>no_faktur</th>
<th>id_produk</th>
<th>id_detail_produk</th>
<th>qty</th>
<th></th>
							</tr>
						</thead>
						...
						?>
							<tr>
								...
								<td><?php echo $a;?></td><td><?php echo $row->no_faktur?></td>
