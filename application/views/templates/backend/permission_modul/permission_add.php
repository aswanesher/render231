...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="permission_save" method="post" enctype="multipart/form-data">
	<?php
	...
	<div class="form-group">
			...
			<div class="col-sm-4">
				<select class="form-control" id="form-field-select-1" name="id_user_group">
					...
					<option value="<?php echo $s->id?>"><?php echo ucfirst($s->type);?></option>
					<?php } ?>
				</select>
			</div>
		</div>
