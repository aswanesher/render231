...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="website_save" method="post" enctype="multipart/form-data">
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Nama Website</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="website_title" placeholder="Nama Website" class="col-xs-10 col-sm-5" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="website_desc" placeholder="website_desc" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Nama Perusahaan</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="company_name" placeholder="company_name" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Alamat</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="contact_address" placeholder="contact_address" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Email</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="contact_email" placeholder="contact_email" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">No Telp</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="contact_phone" placeholder="contact_phone" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">No Fax</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="contact_fax" placeholder="contact_fax" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">No HP</label>

			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="contact_cellphone" placeholder="contact_cellphone" class="col-xs-10 col-sm-5" required />
			</div>
		</div><div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="form-field-1-1" name="favicon" placeholder="favicon" class="col-xs-10 col-sm-5" required />
			</div>
