<div class="page-header">
		<h1>
			...
			<?php if($tambah=='true') { ?>
			<a href="<?php echo base_url();?>testimoni/testimoni_add" class="btn-sm btn-success pull-right"><i class="ace-icon fa fa-pencil-square-o bigger-230"></i> Tambah data</a>
			<?php } ?>
		</h1>
	</div><!-- /.page-header -->
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form class="form-search" method="post" action="<?php echo base_url()?>testimoni">
							<div class="row">
...
<th></th>
						...
						?>
							<tr>
								...
								<td><?php echo $a;?></td><td><?php echo $row->id_testimonial?></td>
...
<td>
									<div class="hidden-sm hidden-xs btn-group">
										<?php if($edit=='true') { ?>
										<a class="btn btn-xs btn-info" href="<?php echo base_url();?>testimoni/testimoni_edit/<?php echo $row->id_testimonial?>">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</a>
										<?php } ?>

										<?php if($hapus=='true') { ?>
										<a class="btn btn-xs btn-danger" href="<?php echo base_url();?>testimoni/testimoni_delete/<?php echo $row->id_testimonial?>" onclick="return confirm('Anda yakin akan menghapus user ini?')">
