                    ...
                    <form role="form" action="<?php echo base_url('change-password-process');?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <div class="input-group login-input">
                                ...
                                <span><input type="password" class="form-control required" name="old_password" placeholder="Kata Sandi Lama"></span>
                            </div>
                            <br>
                            <div class="input-group login-input">
                                <span class="input-group-addon"><i class="fa fa-key"  style="width:14px;"></i></span>
                                <span><input type="password" class="form-control required" name="password" id="password" placeholder="Kata Sandi Baru"></span>
                            </div>
                            <br>
                             <div class="input-group login-input">
                                <span class="input-group-addon"><i class="fa fa-key"  style="width:14px;"></i></span>
                            ...
                            <div class="checkbox">
                                ...
                                <button type="submit" class="btn btn-sm btn-success pull-right login"><i class="fa fa-pencil-square-o"></i> Ubah Kata Sandi</button>
