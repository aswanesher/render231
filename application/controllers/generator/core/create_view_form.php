...
<div class=\"col-xs-12\">
	<!-- PAGE CONTENT BEGINS -->
	<form class=\"form-horizontal\" role=\"form\" action=\"<?php echo base_url('".$controller."/".$controller."_save'); ?>\" method=\"post\" enctype=\"multipart/form-data\">";
...
$target = $pathfolder.$v_form_file;

if ( ! write_file($target, $string)) {
    echo 'Unable to write the form file';
} else {
    echo 'File form written!';
}
